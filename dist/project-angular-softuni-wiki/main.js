...
/* harmony import */ var _article_article_module__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./article/article.module */ "./src/app/article/article.module.ts");
/* harmony import */ var _interceptors_jwt_interceptor__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./interceptors/jwt.interceptor */ "./src/app/interceptors/jwt.interceptor.ts");
...
/* harmony import */ var _navigation_article_navigation_article_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./navigation-article/navigation-article.component */ "./src/app/navigation-article/navigation-article.component.ts");
/* harmony import */ var _navigation_user_navigation_user_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./navigation-user/navigation-user.component */ "./src/app/navigation-user/navigation-user.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _navigation_article_navigation_article_component__WEBPACK_IMPORTED_MODULE_14__["NavigationArticleComponent"],
                _navigation_user_navigation_user_component__WEBPACK_IMPORTED_MODULE_15__["NavigationUserComponent"]
            ],
            imports: [
                ...
                _article_article_module__WEBPACK_IMPORTED_MODULE_11__["ArticleModule"]
            ],
            providers: [
                // AuthService, otiva v AuthModule
                {
                    provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HTTP_INTERCEPTORS"],
                    useClass: _interceptors_jwt_interceptor__WEBPACK_IMPORTED_MODULE_12__["JwtInterceptor"],
                    multi: true
                },
                {
                    provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HTTP_INTERCEPTORS"],
...
module.exports = "<h1>Welcome to SoftUni Wiki!</h1>\n<section>\n  <h2>{{article.title}}</h2>\n  <div class=\"spacer\">\n    <h3>Edit hostory</h3>\n    <ul *ngFor=\"let articleHistory of articleHistoryLs\">\n      <li>\n        <a routerLink=\"/article/details/edit/{{articleHistory._id}}\">{{calcDate(articleHistory.creationDate)}}</a> by\n        <span class=\"author\">{{articleHistory.author.email}}</span>\n      </li>\n    </ul>\n  </div>\n</section>\n"
...
var NavigationArticleComponent = /** @class */ (function () {
    function NavigationArticleComponent(router) {
        this.router = router;
        this.searchText = '';
    }
...
module.exports = __webpack_require__(/*! D:\Angular\angular-demos\project-angular-softuni-wiki\src\main.ts */"./src/main.ts");
